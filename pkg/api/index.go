...
func (hs *HTTPServer) setIndexTokenViewData(c *models.ReqContext, userID, orgID int64) (*dtos.IndexViewData, error) {
	instanceID := c.Params(":instanceID")

	c.OrgRole = models.ROLE_VIEWER
	c.OrgId = orgID
	c.Name = instanceID
